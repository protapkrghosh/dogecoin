      ...
      <Container>
        <div className='flex flex-col-reverse lg:flex-row items-center'>
          <div className="lg:w-1/2 mb-10 lg:mb-0 mt-10 lg:mt-0">
            <h1 className='text-[#FFFFFF] font-redRose text-[43px] md:text-[40px] lg:text-[45px] xl:text-[53px] font-semibold'>What is Doge hot?</h1>
            ...
            <p className='text-[#CCC2C2] font-redRose lg:w-[97%] 2xl:w-[78%]'>At its heart, Doge hot is the accidental crypto movement that makes people smile! It is also an opensource peer-to-peer cryptocurrency that utilises blockchain technology, a highly secure decentralised system of storing information as a public ledger that is maintained by a network of computers called nodes. More than this, though, is the ethos of Doge hot, summarised in the Doge hot Manifesto , and its amazing, vibrant community made up of friendly folks just like you! <br /> <span className='text-[#FF4500] cursor-pointer hover:underline'>LEARN MORE</span></p>
          </div>
