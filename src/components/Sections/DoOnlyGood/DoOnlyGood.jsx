      ...
      <Container>
        <div className='lg:flex items-center md:gap-x-10 lg:gap-x-14 xl:gap-x-20 relative'>
          <div className='lg:w-1/2'>
            ...
            <div style={{ backgroundImage: `url(${shape})` }} className='md:w-[90px] lg:w-[120px] md:h-[90px] lg:h-[120px] bg-no-repeat bg-contain md:-mt-12 lg:-mt-[70px]' data-aos="fade-up" data-aos-duration="1000" />
          </div>

          {/* Content */}
          <div className='lg:w-1/2 md:mt-6 lg:mt-0 xl:-mt-10 2xl:-mt-16 md:ml-10 2xl:-ml-20'>
            <div className='relative'>
              <h2 className='text-[45px] md:text-[40px] lg:text-[45px] xl:text-[53px] text-white font-semibold font-redRose capitalize lg:leading-[70px] mb-7'>Do only good <br /> everyday.</h2>

              <img src={icon} alt="image" className='w-[160px] lg:w-[200px] xl:w-[220px] absolute bottom-0 right-12 md:-right-3 lg:right-3 xl:right-16 2xl:right-52' data-aos="fade-up" data-aos-duration="1000" />
            </div>

            <p className='text-[#E5D8D8] 2xl:text-[18px] font-redRose xl:w-[82%] 2xl:w-[69%]'>The Dogecoin community cares about supporting each other, being kind, teaching people about cryptocurrency, fundraising, having fun, making memes, and being absurd. This is nicely captured by Dogecoin’s unofficial tagline: Do Only Good Everyday. Get involved in our awesome community via the below links:</p>
          </div>
        </div>
      </Container>
    </div>
